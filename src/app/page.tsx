                  ...
                  <ul className="divide-y divide-stone-100 dark:divide-stone-800">
                    {albums.map((album) => (
                      <li key={album.id}>
                        <Link
                          href={`/album/${album.id}`}
                          className="group flex items-center justify-between gap-3 rounded-lg px-2 py-3 -mx-2 transition-colors hover:bg-stone-50 dark:hover:bg-stone-800/60"
                        >
